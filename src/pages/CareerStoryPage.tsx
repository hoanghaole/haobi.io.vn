...
const timeline = [
  ...
  ['Chuyển hóa', 'Tự học Power BI, Obsidian, n8n, AI Studio và nền tảng dữ liệu để biến kinh nghiệm vận hành thành năng lực công nghệ.'],
  ['Hiện tại', 'Xây Career OS: portfolio, case study, knowledge lab và đội AI agent hỗ trợ làm việc mỗi ngày.'],
];
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-950">
      ...
      <main className="mx-auto max-w-4xl px-5 py-16 md:py-24">
        ...
        <h1 className="mt-5 max-w-3xl text-5xl font-semibold tracking-tight md:text-6xl">Từ vận hành truyền thống đến người xây hệ thống dữ liệu, tri thức và AI cho công việc.</h1>
        <p className="mt-8 max-w-2xl text-lg leading-8 text-neutral-600">Đây là câu chuyện nghề nghiệp của Ba: không bắt đầu từ code, mà từ vận hành thật, dữ liệu thật, ghi chú thật và nhu cầu thật. Công nghệ là đòn bẩy để kinh nghiệm đó đi xa hơn.</p>
        ...
        <section className="mt-16 border border-neutral-200 bg-neutral-50 p-8">
          ...
          <p className="mt-4 text-lg leading-8 text-neutral-700">Một người vận hành biết dùng Power BI, Obsidian, tự động hóa và AI/no-code để tạo ra hệ thống làm việc gọn hơn, rõ hơn và bền hơn cho cá nhân/doanh nghiệp nhỏ.</p>
