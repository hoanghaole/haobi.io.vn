...
['src/pages/HmsLandingPage.tsx', 'src/pages/BlogHomePage.tsx', 'src/pages/ArticleDetail.tsx'].forEach(p => updateMenu(p));

// EcoHubPage doesn't have a <nav> but a sidebar with menu items maybe? Let's check EcoHubPage.
